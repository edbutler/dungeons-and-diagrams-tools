...
def assert_connected(
    ...
    for i in range(len(potential_nodes)):
        ...
        # The source node must be in the graph and have no used incoming edges.
        solver.add(
            z3.Implies(
                is_source,
        ...
        # Note that the converse is stronger (incluces outgoing_edges), so we can't simplify to an equivalence.
